 ...
 <!-- ======= Sidebar ======= -->
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Ceuilleur</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <!-- <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4"> -->
                  <div class="container">
                    <div class="card p-4 table-font">
                      ...
                      <div class="m-2"><a href="#" class="btn btn-outline-success bouton-cover" id="add3"><span><i class="bi bi-building-add"></i></span><span>Ajouter</span></a></div>
                      <div id="contenue">
                      <table class="table datatable mt-3">
                        ...
                        <tbody>
                          <?php for ($i=0; $i <count($data) ; $i++) { ?>
                            <tr>
                              <th scope="row"><?php echo($data[$i]['idCueilleur']); ?></th>
                              <td><?php echo($data[$i]['nom']); ?></td>
                              <td><?php echo($data[$i]['prenom']); ?></td>
                              <td><?php echo($data[$i]['sexe']); ?></td>
                              <td><?php echo($data[$i]['adresse']); ?></td>
                              <td><?php echo($data[$i]['dateNaissance']); ?></td>
                              <td><?php echo($data[$i]['dateEmbauche']); ?></td>
                              <td><a href="../inc/delete.php?tabName=removeCueilleurs&&id=<?php echo($data[$i]['idCueilleur']); ?>" class="btn btn-outline-danger"><i class="bi bi-trash"></i></a></td>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      ...
      <br>
      <stsong>Mathieu ETU002492 && Aneliot ETU2533</stsong>
    </div>
    <div class="credits">
  ...
  <script src="../assets/js/changeinput copy 3.js"></script>
