...
<!-- </div> -->
 ...
 <!-- ======= Sidebar ======= -->
                ...
                <!-- <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4"> -->
                  <div class="container">
                    <div class="card p-4 table-font">
                      ...
                      <div class="m-2"><a href="#" class="btn btn-outline-success bouton-cover" id="add2"><span><i class="bi bi-building-add"></i></span><span>Ajouter</span></a></div>
                      <div id="contenue">
                      <table class="table datatable mt-3">
                        ...
                        <tbody>
                          <?php for ($i=0; $i <count($data) ; $i++) { ?>
                            <tr>
                              <th scope="row"><?php echo($data[$i]['idParcelle']); ?></th>
                              <td><?php echo($data[$i]['surface']); ?></td>
                              <td><?php echo(getNomVar($data[$i]['idVar'])); ?></td>
                              <td><a href="../inc/delete.php?tabName=removeParcelle&&id=<?php echo($data[$i]['idParcelle']); ?>" class="btn -outline-danger"><i class="bi bi-trash"></i></a></td>
  ...
  <script src="../assets/js/changeinput copy 2.js"></script>
