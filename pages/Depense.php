...
<!-- </div> -->
  ...
  <aside id="sidebar" class="sidebar bar-font">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Depense.php">
          <i class="bi bi-person"></i>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Type Depense</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <!-- <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4"> -->
                  <div class="container">
                    <div class="card p-4 table-font">
                      ...
                      <div class="m-2"><a href="#" class="btn btn-outline-success bouton-cover" ><span><i class="bi bi-building-add"></i></span><span>Ajouter</span></a></div>
                      <div id="contenue">
  ...
  <script src="../assets/js/changeinput copy 4.js"></script>
