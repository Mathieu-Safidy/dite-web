                      ...
                      <div class="m-2">
                        <!-- <div class="card">
                                  ...
                                  <div class="accordion-body">
                                    <div class="container">
                                        <div class="col-12">
                                            ...
                                            <form action="../inc/traitement.php" class="form">
                                            <div class="col-md-6 mb-3 offset-3">
                                              <input type="hidden" name="tabName" value="depense">
                                                <div class="form-floating text-center">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="montant" name="montant">
                                          ...
                                          <div class="form-floating text-center">
                                            <input type="DATE" class="form-control" id="floatingName" placeholder="Date de depense" name="dateDep">
                                            <label for="floatingName">Date de depense</label>
                                          </div>
                            ...
                            <select class="form-select" aria-label="Default select example" name="idCate">
                              ...
                              <?php 
                                    $table = getTable("v_categorie");
                                    for($i = 0; $i < count($table); $i++) {
                                ?>
                                <option value="<?php echo($table[$i]['idCate']) ?>"><?php echo($table[$i]['nom']) ?></option>
                                    <?php } ?>
                              </select>
                            </div>
                    ...
                    <table class="table datatable mt-3">
                      ...
                      <tbody>
                       <?php for ($i=0; $i <count($data) ; $i++) { ?>
                            <tr>
                              <th scope="row"><?php echo($data[$i]['idDep']); ?></th>
                              <td><?php echo($data[$i]['montant']); ?></td>
                              <td><?php echo($data[$i]['dateDep']); ?></td>
                              <td><?php echo(getNomCate($data[$i]['idCate'])); ?></td>
                              <td><a href="../inc/delete.php?tabName=removeDepense&&id=<?php echo($data[$i]['idDep']); ?>" class="btn btn-outline-danger"><i class="bi bi-trash"></i></a></td>
