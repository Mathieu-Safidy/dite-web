...
<!-- </div> -->
 ...
 <!-- ======= Sidebar ======= -->
  ...
  <main id="main" class="main body-font">
    ...
    <div class="pagetitle">
      <h1>Cat&eacute;gorie D&eacute;pense</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <!-- <li class="breadcrumb-item">Pages</li> -->
          <li class="breadcrumb-item active">Cat&eacute;gorie D&eacute;pense</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <!-- <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4"> -->
                  <div class="container">
                    <div class="card p-4 table-font">
                      ...
                      <div class="m-2"><a href="#" class="btn btn-outline-success bouton-cover" id="add7"><span><i class="bi bi-building-add"></i></span><span>Ajouter</span></a></div>
                      <div id="contenue"></div>
                      <table class="table datatable mt-3">
                        ...
                        <tbody>
                           <?php for ($i=0; $i <count($data) ; $i++) { ?>
                            <tr>
                              <th scope="row" class="idCate"><?php echo($data[$i]['idCate']); ?></th>
                                 <td class="nom"><?php echo($data[$i]['nom']); ?></td>
                              <td><a href="../inc/delete.php?tabName=removeCate&&id=<?php echo($data[$i]['idCate']); ?>" class="btn btn-outline-danger"><i class="bi bi-trash"></i></a></td>
                              <td><a href="#" class="btn btn-outline-success" id="upd7"><i class="bi bi-wrench-adjustable"></i></a></td>
                            </tr>
                          <?php } ?>
                        </tbody>
  ...
  <script src="../assets/js/changeinput copy 6.js"></script>
